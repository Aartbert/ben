...
/**
 * This class represents an 'or' operator within an AST and is responsible for logic regarding 'or' operations.
 */
public class OrOperator extends Operator {
    ...
    public void check(Attribute attribute, ILiteral value) {
        if (attribute.getType() != LiteralType.BOOL || value.getType() != LiteralType.BOOL) {
            throw new CompilerException("Both operands in 'Or' operations must be of type 'Bool'");
        }
    }
}

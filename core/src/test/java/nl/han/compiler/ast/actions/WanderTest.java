...
public class WanderTest {
     ...
     */
    @Test
    @DisplayName("test if the LOOP_ROND action is returned")
    void testGetAction() {
        // Arrange
        List<Action> expected = List.of(Action.MOVE_AROUND);
     ...
     */
    @Test
    @DisplayName("test if wander transforms to get stamina condition")
    void testTransform() {
        // Arrange
